...
class FairseqModel(nn.Module):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens):
        ...
        decoder_out, avg_attn_scores, final_pgen_scores = self.decoder(prev_output_tokens, encoder_out)
        return decoder_out, avg_attn_scores, final_pgen_scores
        # decoder_out, avg_attn_scores, final_attn_scores, final_pgen_scores = self.decoder(prev_output_tokens, encoder_out)
        # return decoder_out, avg_attn_scores, final_attn_scores, final_pgen_scores
